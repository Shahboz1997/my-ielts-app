...
export const landingPageMetadata = {
  title: 'STRATUM.ai — IELTS Writing Task 1 & Task 2 AI Examiner',
  ...
  openGraph: {
    ...
    url: baseUrl,
    siteName: 'STRATUM.ai',
    title: 'STRATUM.ai — IELTS Writing AI Examiner',
    description: LANDING_HERO.description,
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'STRATUM.ai IELTS Writing' }],
  },
  twitter: {
