        ...
        <div className="p-8">
          ...
          <AnimatePresence mode="wait">
            {error && (
              <motion.div 
                ...
                className="mb-4 p-3 bg-red-600/10 border border-red-600/20 rounded-xl flex items-center gap-2 text-red-600 text-[10px] font-bold"
              >
          ...
          <div className="mt-6 text-center">
            <button 
              ...
              className="text-[10px] font-black uppercase text-slate-500 hover:text-red-600 transition-colors italic"
            >
